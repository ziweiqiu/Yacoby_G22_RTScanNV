...
def fit_double_lorentzian(x_values, y_values, starting_params=None, bounds=None):
    ...
    Args:
        ...
        bounds: Optionally, include bounds for the parameters in the gaussian fitting, in the following form:
                [(offset_lb, fwhm1_lb, fwhm2_lb,amplitude1_lb, amplitude2_lb, center1_lb, center2_lb),
                (offset_ub, fwhm1_ub, fwhm2_lb,amplitude1_ub, amplitude2_ub, center1_ub, center2_ub)]
...
def double_lorentzian(x, constant_offset, fwhm1, fwhm2, amplitude_1, amplitude_2, center_1, center_2):
    """
    ...
    """
    return lorentzian(x, constant_offset / 2, amplitude_1, center_1, fwhm1) + lorentzian(x, constant_offset / 2,
                                                                                        amplitude_2, center_2, fwhm2)
...
def fit_rabi_decay(t, y, variable_phase=True, verbose=False, return_guess = False):
    """
