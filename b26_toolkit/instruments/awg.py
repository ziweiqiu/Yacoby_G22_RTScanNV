        ...
        for key, value in settings.items():
            ...
            if key == 'VISA_address':
                ...
                if key == 'display_on':
                    ...
                    if value > AMP_MAX:
                        print('Invalid amplitude. All amplitudes must be between 0 and 20Vpp. Set to 20Vpp instead')
                        value = 20.0
                    elif value < AMP_MIN:
                        print('Invalid amplitude. All amplitudes must be between 0 and 20Vpp. Set to 0Vpp instead')
                        value = 0.0
                elif key == 'offset':
                    if value > 10.0:
                        print('Invalid amplitude/offset. All amplitudes/offsets must be between -10 and 10Vdc. Set to 10Vdc instead')
                        value = 10.0
                    elif value < -10:
                        print('Invalid amplitude/offset. All amplitudes/offsets must be between -10 and 10Vdc. Set to -10Vdc instead')
                        value = -10.0
